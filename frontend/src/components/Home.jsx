                        ...
                        <div class="md:p-6 p-3">
                            ...
                            <ul class="my-4 space-y-3">
                                ...
                                <div class="flex items-center p-3 text-base font-bold px-4 text-gray-900 bg-gray-200 rounded-lg hover:bg-gray-300 group hover:shadow">
                                    ...
                                    <span class="flex-1 ml-6 whitespace-nowrap">OSAS</span>
                                    <span class="flex-1 ml-3 whitespace-nowrap">0.5eth</span>
                                    <span class=" items-center justify-center px-2 py-2 text-white ml-3 text-sm md:text-lg bg-[#FF6937] font-semibold rounded-xl">
                                        Support
                                    </span>
                                </div>
