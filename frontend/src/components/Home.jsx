    ...
    return (
        <div className='w-full bg-[#FDFDFC] flex gap-5 justify-center items-center flex-col'>
            ...
            <div className='w-full flex justify-center md:mb-40 mb-20 '>
                <div className="relative md:w-1/2 w-11/12 h-full md:h-auto ">

                    <div className="relative bg-[#FFFCE6] rounded-lg shadow px-2">
                        <div className="py-4 px-6 rounded-t border-b flex justify-center ">
                        ...
                        <div className="md:p-6 p-3">
                            ...
                            <ul className="my-4 space-y-3">
                                ...
                                {recent?.map((item) => (
                                    <div className="flex items-center p-3 text-base font-bold px-4 text-gray-900 bg-gray-200 rounded-lg hover:bg-gray-300 group hover:shadow">
                                        ...
                                        <span className="flex-1 ml-6 whitespace-nowrap">{item?.name}</span>
                                        <span className="flex-1 flex items-center ml-3 whitespace-nowrap"><FaEthereum /> {item?.balance.toString()} </span>
                                        <Link to={`/creator/${item?.addr}`} className=" items-center justify-center cursor-pointer hover:bg-orange-500 px-2 py-2 text-white ml-3 text-sm md:text-lg bg-[#FF6937] font-semibold rounded-xl">
                                            Support
                                        </Link>
                                    </div>
                                ))}
